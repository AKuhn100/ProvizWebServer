...
p.grid.grid_line_color = '#404040'
p.axis.axis_line_color = '#404040'
p.axis.major_tick_line_color = '#404040'
p.axis.minor_tick_line_color = '#404040'
...
p.legend.border_line_color = '#404040'
p.legend.text_color = '#e0e0e0'
...
# Apply dark theme to scatter plot
p_scatter_exp.grid.grid_line_color = '#404040'
p_scatter_exp.axis.axis_line_color = '#404040'
p_scatter_exp.axis.major_tick_line_color = '#404040'
p_scatter_exp.axis.minor_tick_line_color = '#404040'
p_scatter_exp.axis.major_label_text_color = '#e0e0e0'
p_scatter_exp.title.text_color = '#e0e0e0'
p_scatter_exp.xaxis.axis_label_text_color = '#e0e0e0'
p_scatter_exp.yaxis.axis_label_text_color = '#e0e0e0'
p_scatter_af = figure(
    sizing_mode="stretch_both",
    aspect_ratio=1,
    min_width=350,
...
# ColumnDataSources for scatter plots
...
header = Div(text="""
    <h1 style="color: #e0e0e0;">Evolutionary Frustration</h1>
    <p>
...
custom_styles = Div(text="""
    <style>
        ...
        .bk-data-table td, .bk-data-table th {
            background-color: #2a2a2a !important;
            color: #e0e0e0 !important;
