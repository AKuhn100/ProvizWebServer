...
# (F) Remove Toggles for Correlation Table and Unity Viewer
# Since the user wants both the protein visualizer and table to always show,
# we remove the toggle buttons and related code.

# (G) Create Unity iframe with improved styling (Removed Toggle Fullscreen)
unity_iframe = Div(
    text="""
...
# (H) Add Protein Visualizer Description and Instructions
...
visualization_section = column(
    select_test,
    p,
    protein_viz_description,
    unity_iframe,
    sizing_mode='stretch_width',
    css_classes=['visualization-section']
)

# Controls section with filters (Removed Toggles)
